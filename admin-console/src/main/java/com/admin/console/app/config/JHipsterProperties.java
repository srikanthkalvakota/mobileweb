package com.admin.console.app.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "AdminConsole@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "AdminConsole API";

        private String description = "AdminConsole API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "AdminConsole";
