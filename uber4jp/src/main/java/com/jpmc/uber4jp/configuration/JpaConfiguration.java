package com.jpmc.uber4jp.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.jpmc.uber4jp.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.jpmc.uber4jp.model" });
